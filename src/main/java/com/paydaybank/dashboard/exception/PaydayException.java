...
public class PaydayException {
    ...
    private static RuntimeException throwException(ExceptionType exceptionType, String messageTemplate, String... args) {
        if (ExceptionType.NOT_FOUND.equals(exceptionType)) {
            return new PaydayException.EntityNotFoundException(format(messageTemplate, args));
        } else if (ExceptionType.DUPLICATE.equals(exceptionType)) {
            return new PaydayException.DuplicateEntityException(format(messageTemplate, args));
        }
        return new RuntimeException(format(messageTemplate, args));
    }
